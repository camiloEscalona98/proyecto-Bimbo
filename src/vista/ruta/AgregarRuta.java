...
/**
 * Jframe creado para agregar nueva ruta a BD
 * @author camilo
 */
public class AgregarRuta extends javax.swing.JFrame {
    ...
    /**
     * metodo necesario para la carga del comboBox con datos del vendedor
     */
    private void cargarCombo() {
        listaGenerica = new ListaGenerica();
        mapVendedor = listaGenerica.generarValoresVendedor();
        for (String vendedor : mapVendedor.keySet()) {
            cmb_vendedor.addItem(vendedor);
        }
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cmb_vendedor, 0, 168, Short.MAX_VALUE)
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        int idRuta = Integer.parseInt(txt_id.getText());
        int idVendedor = mapVendedor.get(cmb_vendedor.getSelectedItem().toString());
        String dia = txt_dia.getText();
        
       Ruta ruta = new Ruta();
       ruta.setId_ruta(idRuta);
       ruta.setRut_vendedor(idVendedor);
       ruta.setDia(dia);
       ruta.agregarDatos();
       txt_id.setText("");
